#  [漏洞复现-29]金*OA-EAS-myUploadFile-文件上传漏洞
...
0x01漏洞概述
        ...
        金*OA-EAS-myUploadFile-文件上传漏洞，攻击者可构造恶意请求获取系统信息等及其它安全风险。
...
0x03漏洞详情
       ...
       简述： ** ** **金*OA-EAS-myUploadFile-文件上传漏洞** **， 攻击者可构造恶意请求获取系统信息，造成数据系统及其它安全风险。******
