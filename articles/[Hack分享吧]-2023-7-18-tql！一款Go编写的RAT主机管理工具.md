...
这是一款使用go编写的RAT主机群管理工具，已具备命令控制台、文件管理、屏幕截屏、开机启动服务、NPS代理等功能。  

  

 **流量：** 支持TCP，UDP/KCP协议，通讯默认使用tls证明书进行加密
...
###  **1\. 管理功能**
  ...
  *   *   *   *   * 
     ...
     文件管理交互式虚拟终端，Linux、MacOS、Windows都支持交互屏幕截屏添加开机启动...
 ...
 **客户端支持**
  ...
  *   * 
     ...
     stager 小体积客户端（C/C++ 几十K到几百K）stagerless 大体积客户端 （golang编写，经过upx压缩，有5-6M）
